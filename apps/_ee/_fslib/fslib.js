...
function deleteItemCheck() {
	...
	if(deleteData[2] === 'file'){
		jQuery("#fslibDialog h1").text("DELETE THIS FILE");
		jQuery("#fslibDialog .text").text("Are you sure you want to permanently delete this file?  Note: there is no undo on this operation.");
	}else{
		jQuery("#fslibDialog h1").text("DELETE THIS DIRECTORY");
		jQuery("#fslibDialog .text").text("Are you sure you want to permanently delete this directory and all directories and images below it?  Note: there is no undo on this operation.");
	}
...
function changeName(){
	...
	jQuery(".choice-yes").attr({id:"choice-yes"});
		...
		jQuery("#fslibDialog h1").text("RENAME THIS FILE / DIRECTORY");
...
function imageModal(imageData){
	var src = '_ee/_fslib/image-display.php?imagedata='+imageData;
