<div id="list-<?php echo $id; ?>" class="sOrd">
    ...
    <h3>
        ...
        <div class="col-md-4 imgBox" style="padding-left:0;"><?php if($cover == 'false'){ echo '<span class="glyphicon glyphicon-picture" style="font-size:72pt;"></span>'; }else{ echo '<img style="width:100%;" src="apps/dropzone/upload/'.$album.'/'.$cover.'" alt="" />'; }; ?>
        </div>
