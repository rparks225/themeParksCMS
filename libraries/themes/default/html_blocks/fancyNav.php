<div class="fancyNav">
   ...
   <div class="row">
    <div class="col-md-12 col-sm-12 fancDrop">
    
        <div class="col-md-2">

        <img style="width:100%;" src="/themeparks/apps/_ee/files/arlington.jpg" />
        ...
        <li class="title">The Arlington Center</li>
            ...
            <img style="width:100%;" src="/themeparks/apps/_ee/files/burl.gif" />
            ...
            <li class="title">The Burlington Center</li>
                ...
                <li><a href="{% echo ROOT %}">Virtual Tours</a></li>
                 ...
                 <img style="width:100%;" src="/themeparks/apps/_ee/files/concordentrancesml.jpg" />
             ...
             <img style="width:100%;" src="/themeparks/apps/_ee/files/grotonentrance.jpg" />
       ...
       <img style="width:100%;" src="/themeparks/apps/_ee/files/miltonentrance_000.jpg" />
