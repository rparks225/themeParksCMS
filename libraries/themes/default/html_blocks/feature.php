    ...
    <div>
            ...
            <div class="col-md-8 col-sm-10 col-xs-9" style="padding-left:0;">  
                ...
                <div class="col-md-4 col-sm-2 col-xs-3 imgBox" style="overflow:hidden;height:auto;padding-right:0;">
                    ...
                    <a href="<? echo ROOT ?>apps/dropzone/upload/Posts/<?php echo $img;?>" rel="prettyPhoto"><img class="lazy" data-original="<? echo ROOT ?>apps/dropzone/upload/Posts/<? if(!empty($img)){echo $img;}else{ echo 'image.png';} ?>" alt="<? echo $img; ?>" style="width: 100%; height: 140px;" /></a><br>
