...
(7, 'Post', 'screen1.png', 'Blog Post Images', 0),
(8, 'NewGal', 'perscription.jpg', 'News Gallery Images', 1),
(10, 'oneLastImageGallery', 'screen1.png', 'One Last Image Gallery', 2);
...
(14, 'home', 'false', '', 'Home page', 'Home, page, home page', 'Welcome to ThemeParks CMS'),
...
(26, 'admin', 'false', '', 'false', '', 'Log into the Dasboard'),
...
(47, 'About', 'true', '', 'A little about how we came to be and how BaneCare was started.', 'About BaneCare, BaneCare, BaneCare', 'About themeParksCMS'),
...
(64, 'baneNorth', 'true', '', 'false', '', 'Bane Care North'),
(66, 'settings', 'false', '', 'false', '', 'Admin Settings'),
(67, 'Posts', 'false', '', 'Page description.', 'News & Media, themeParks News', 'New & Media');
...
(1, 'ThemeParks CMS', 'Rob Parks', 'http://localhost/themeParksCMS/', '6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI', '/themeParkscms/', '/themeParksCMS/includes/admin/_ee', 'localhost', 'false', '', '', 'tls', '25', '', 'themeParksCMS Website', '', '', 'New Contact Form Message.', 'default', 'themeParks');
