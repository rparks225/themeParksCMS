...
<body>
    ...
    <div class="fixed-action-btn click-to-toggle tooltipped" data-position="left" data-tooltip="Manage Site" style="z-index:9999999;">
        ...
        <ul>
            <li>
                <a class="btn-floating waves-effect waves-red tooltipped" data-position="left" data-tooltip="Manage Pages" href="<?php echo ROOT; ?>tp-Pages-1">
                        <i class="material-icons left">mode_edit</i>Manage Pages</a>
            </li>
            <li>
                <a class="btn-floating waves-effect waves-red tooltipped" data-position="left" data-tooltip="Manage Posts" href="<?php echo ROOT; ?>tp-Post">
                    <i class="material-icons left">assignment</i>Manage Posts</a>
            </li>
            <li>
                <a class="btn-floating waves-effect waves-red tooltipped" data-position="left" data-tooltip="Manage Images" href="<?php echo ROOT; ?>tp-Image">
                    <i class="material-icons left">perm_media</i>Image Library</a>
            </li>
            <li>
                <a class="btn-floating waves-effect waves-red tooltipped" data-position="left" data-tooltip="Manage Nav Menues" href="<?php echo ROOT; ?>tp-Menu">
        ...
        <div class="nav-wrapper">
            <div class="row">
                <b style="color:white;padding:0;margin-top:1.1rem;">
                   <a href="<?php echo ROOT; ?>tp-Dashboard"><span style="color:#77273F;font-size:1.5em;">{&nbsp;</span><span class="circle" style="background:#00838f;padding:10px;">TP</span><span style="color:#77273F;font-size:1.5em;">&nbsp;}</span>
                       </a></b>
                <a href="#" data-target="slide-out" class="right sidenav-trigger show-on-medium-and-down"><i class="material-icons">menu</i></a>
                <ul class="right hide-on-med-and-down">
                    <li>
                        <a href="<?php echo ROOT; ?>tp-Dashboard" class="white-text  waves-effect waves-red active">
                            <i class="material-icons left">dashboard</i>Back to Dashboard</a>
                    </li>
                    <li>
                        <a class="white-text  waves-effect waves-red" href="<?php echo ROOT; ?>Home">
    ...
    <ul class="sidenav grey darken-3" id="slide-out">
        <li><div class="user-view">
            ...
            <div class="background" style="z-index:-1;">
                <img width="100%" src="<?php echo ROOT; ?>includes/admin/assets/images/newBg.jpg">
            </div>
            <a style="z-index:10;position:relative;" href="#user"><img width="35%" src="<?php echo ROOT; ?>includes/admin/assets/images/logo.png"></a>
            <a style="z-index:10;position:relative;" href="#name"><span class="white-text name">You are logged in as:</span></a>
            <a style="z-index:10;position:relative;" href="#email"><span class="white-text email"><?php userInfo('userName'); ?></span></a>
            </div></li>
        <li>
            <a href="<?php echo ROOT; ?>tp-Dashboard" class="white-text  waves-effect waves-red active">
        ...
        <li>
            <a class="white-text  waves-effect waves-red" href="<?php echo ROOT; ?>tp-Settings">
    ...
    <div class="row" style="padding:1rem 0 2rem 40px;background:#00838F;">
        <div>
                <h1 class="valign light white-text"><?php echo $tits; ?></h1>
        </div>
    </div>
